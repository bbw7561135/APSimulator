...
class FilterSet:
    ...
    def construct_filtered_flux_array(self, filtered_fluxes, filter_names, filter_indices, color_axis=0):
        ...
        for idx in range(n_included_filters):
            filtered_flux_array[filter_indices[idx], :] = filtered_fluxes[filter_names[idx]]#/(self.filters[filter_names[idx]].maximum_wavelength - self.filters[filter_names[idx]].minimum_wavelength)
